...
@section('title', 'Yeni Marka - N2N Admin')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <textarea id="description_tr" name="description_tr" rows="4" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description_tr') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="description_en" name="description_en" rows="4" required
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description_en') }}</textarea>
                    </div>
                </div>
