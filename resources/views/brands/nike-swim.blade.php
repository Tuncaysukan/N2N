...
@section('content')
<!-- Hero Section -->
<section class="bg-gradient-to-r from-blue-500 to-cyan-600 text-white py-20 relative">
            ...
            <div class="text-center">
                ...
                @else
                    <div class="w-64 h-64 mx-auto bg-white/10 backdrop-blur-sm rounded-lg flex items-center justify-center">
                        <span class="text-3xl font-bold text-white">NS</span>
                    </div>
                @endif
            </div>
        </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="bg-blue-50 p-4 rounded-lg">
                        <h4 class="font-semibold text-blue-800 mb-2">{{ __('messages.quality') }}</h4>
                        <p class="text-blue-600">{{ __('messages.quality_description') }}</p>
                    </div>
                    <div class="bg-cyan-50 p-4 rounded-lg">
                        <h4 class="font-semibold text-cyan-800 mb-2">{{ __('messages.innovation') }}</h4>
                        <p class="text-cyan-600">{{ __('messages.innovation_description') }}</p>
                    </div>
                </div>
            </div>
            <div>
