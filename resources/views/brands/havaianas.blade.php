...
@section('content')
<!-- Hero Section -->
<section class="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20 relative">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="bg-purple-50 p-4 rounded-lg">
                        <h4 class="font-semibold text-purple-800 mb-2">{{ __('messages.innovation') }}</h4>
                        <p class="text-purple-600">{{ __('messages.innovation_description') }}</p>
                    </div>
                </div>
            </div>
            <div>
